            ...
            <div className="flex flex-col lg:flex-row gap-4 md:gap-5 w-full">
              ...
              <div className="flex flex-col sm:flex-row justify-between gap-3 sm:gap-4 pt-4 md:pt-5">
                <button
                  type="button"
                  onClick={handleClose}
                  className="px-4 py-2 bg-gray-500 text-white hover:bg-gray-700 hover:font-bold rounded transition duration-300 text-font "
                >
                  Cancel
                </button>
...
//                   type="submit"
//                   disabled={isLoading}
//                   className="px-4 py-2 bg-green-500 text-white hover:bg-green-700 hover:font-bold rounded "
//                 >
//                   {
//                   isLoading
//                     ? editingProduct ? "Updating..." : "Creating..."
