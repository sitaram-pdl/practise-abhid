...
export default function AddNewUserModal() {
    ...
    return (
        <>
            <div  
                className="fixed inset-0 z-50 backdrop-brightness-40 bg-black bg-opacity-50"
                onClick={handleClose}
            />
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <div className="flex flex-col gap-5">
                            ...
                            <div className="flex justify-between items-center w-full">
                                <button
                                    type="button"
                                    className="px-4 py-2 bg-gray-500 text-white hover:bg-gray-700 rounded transition-colors"
                                    onClick={handleClose}
                                >
                                    Cancel
                                </button>
                                ...
                                <button
                                    type="submit"
                                    className="px-4 py-2 bg-green-500 text-white hover:bg-green-700 rounded transition-colors"
                                >
                                    Create User
                                </button>
                            </div>
